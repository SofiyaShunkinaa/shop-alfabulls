@csrf
 ...
 <div class='flex_form_profuct'>
        ...
        <div class="form-group_flex">
            <p>Описание товара</p>
            <textarea name="content" required rows="4">{{ old('content') ?? $product->content ?? '' }}</textarea>
        </div>
        <div class="form-group_flex">
            <p>Состав</p>
            <textarea name="composition" required>{{ old('composition') ?? $product->composition ?? '' }}</textarea>
        </div>
    ...
    <div class="form-group_flex">
          ...
          <div class="flex_sticer">
                <label>
                    <div >
                      <input type="radio"  name="drone" value="vip">
                      <img src="/img/stik1.png">
                    </div>
                </label>
                 <label>
                    <div >
                      <input type="radio"  name="drone" value="sale">
                      <img src="/img/stik2.png">
                    </div>
                </label>
                 <label>
                    <div >
                      <input type="radio"  name="drone" value="new">
...
<div class="dublicates">
        ...
        <div class="dublicates_box">
            ...
            @for($i =0; $i < 7; $i++)
                <div>
                    <label>
                        <input type="file" name="images[{{ $variantIndex }}][]" accept="image/*",>
        ...
        <div class="dublicates_box">
            ...
            <div class="flex_dovl_flex">
                ${[...Array(7)].map(() => `
                    <div>
                        <label>
                            <input type="file" name="images[${index}][]" accept="image/*" multiple>
                            <img src="/img/dovn.png">
                        </label>
                    </div>
                `).join('')}
