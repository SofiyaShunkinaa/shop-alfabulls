...
@section('content')
    ...
    <div class="wrapper">
        <div class="breadcrumbs__inner">
            ...
            <section class="order">
               <div class="wrapper">
                <h1 class="anim-title" style="translate: none; rotate: none; scale: none; opacity: 1; transform: translate(0px, 0px); text-align: center;">Успех! Спасибо что сделали у нас заказ!</h1>
